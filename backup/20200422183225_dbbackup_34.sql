-- DB BACK UP Created on: 04/22/2020 18:32:25
...
CREATE TABLE `coa` (
  ...
  `archived` int(1) DEFAULT '0',
  PRIMARY KEY (`idCoa`)
) ENGINE=MyISAM AUTO_INCREMENT=4101001 DEFAULT CHARSET=latin1;:||:Separator:||:
...
LOCK TABLES `coaaffiliate` WRITE;:||:Separator:||:
 INSERT INTO `coaaffiliate` VALUES(1,4101000,2),(2,3101000,2),(3,2101000,2),(4,1102000,2),(5,1101000,2);:||:Separator:||:
...
LOCK TABLES `coaaffiliatehistory` WRITE;:||:Separator:||:
 INSERT INTO `coaaffiliatehistory` VALUES(1,4101000,6,2),(2,3101000,7,2),(3,2101000,8,2),(4,1102000,9,2),(5,1101000,10,2);:||:Separator:||:
...
LOCK TABLES `employeeaffiliate` WRITE;:||:Separator:||:
 INSERT INTO `employeeaffiliate` VALUES(2,102,2,1,0);:||:Separator:||:
...
LOCK TABLES `employeeclass` WRITE;:||:Separator:||:
 INSERT INTO `employeeclass` VALUES(25,'Probationary',0),(26,'Executive Staff',0),(27,'Senior Staff',0),(31,'sampless',0),(33,'sample1',1),(34,'sample 2',1),(35,'sample',1),(36,'Smaplee',0),(37,'sam',0),(38,'cszxc',1),(39,'vdfvdf-1',0),(40,'Outsider',0);:||:Separator:||:
...
CREATE TABLE `employmenthistoryposition` (
  ...
  `monthRate` text,
  PRIMARY KEY (`idEmpHistory`)
) ENGINE=InnoDB AUTO_INCREMENT=194 DEFAULT CHARSET=latin1;:||:Separator:||:
...
LOCK TABLES `invadjustment` WRITE;:||:Separator:||:
 INSERT INTO `invadjustment` VALUES(1,1,6,1,50.00,5,0,6,'0000-00-00');:||:Separator:||:
...
CREATE TABLE `logs` (
  ...
  `idModule` int(11) DEFAULT NULL,
  PRIMARY KEY (`idLog`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=latin1;:||:Separator:||:
...
LOCK TABLES `reference` WRITE;:||:Separator:||:
 INSERT INTO `reference` VALUES(1,'PO','Purchase Order',2,0,0),(2,'RE','Receiving',25,0,0),(3,'PR','Purchase Return',29,0,0),(4,'SO','Sales Order',17,0,0),(5,'SE','Sales',18,0,0),(6,'SR','Sales Return',21,0,0),(7,'IC','Inventory Conversion',22,0,0),(8,'I-AD','Inventory Adjustment',23,0,0),(9,'VR','Vouchers Receivable',58,0,0),(10,'VP','Vouchers Payable',57,0,0),(11,'A-AD','Accounting Adjustment',48,0,0),(12,'CR','Cash Receipt',28,0,0),(13,'BB','Beginning Balance',62,0,0);:||:Separator:||:
...
LOCK TABLES `referenceaffiliate` WRITE;:||:Separator:||:
 INSERT INTO `referenceaffiliate` VALUES(1,1,2),(2,2,2),(3,3,2),(4,4,2),(5,5,2),(6,6,2),(7,7,2),(8,8,2),(9,9,2),(10,10,2),(11,11,2),(12,12,2),(13,13,2);:||:Separator:||:
...
LOCK TABLES `referenceseries` WRITE;:||:Separator:||:
 INSERT INTO `referenceseries` VALUES(1,'2018-03-05',2,null,2,1,1,10,1),(2,'2020-04-22',2,null,2,1,1,10,0),(3,'2020-04-22',2,null,2,1,1,10,0),(4,'2020-04-22',2,null,25,2,1,10,0),(5,'2020-04-22',2,null,29,3,1,10,0),(6,'2020-04-22',2,null,17,4,1,10,0),(7,'2020-04-22',2,null,18,5,1,10,0),(8,'2020-04-22',2,null,21,6,1,10,0),(9,'2020-04-22',2,null,22,7,1,10,0),(10,'2020-04-22',2,null,23,8,1,10,0),(11,'2020-04-22',2,null,58,9,1,10,0),(12,'2020-04-22',2,null,57,10,1,10,0),(13,'2020-04-22',2,null,48,11,1,10,0),(14,'2020-04-22',2,null,28,12,1,10,0),(15,'2020-04-22',2,null,62,13,1,10,0);:||:Separator:||:
